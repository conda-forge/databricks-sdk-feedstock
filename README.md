About databricks-sdk-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/databricks-sdk-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/databricks-sdk-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add databricks-sdk
# for installing globally
pixi global install databricks-sdk
```
...
It is possible to list all of the versions of `databricks-sdk` available on your platform:
...
```
pixi search databricks-sdk --channel conda-forge
```
